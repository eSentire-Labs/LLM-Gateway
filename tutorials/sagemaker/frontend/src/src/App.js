/*
This is NOT production ready. This is a proof of concept integrating with the meta-llama/Llama-2-7b in AWS Sagemaker
*/
...
function App() {
  ...
  }, [temperature, topP, jwtToken, messages, model]);
  ...
  const sendChatGPTMessage = useCallback(() => {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log(response.data[0].generation)
        const replyObj = response.data[0].generation
